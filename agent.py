...
Respond ONLY with valid JSON and nothing else. No markdown. No backticks. Just raw JSON:
...
def publish_to_ghost(post):
    ...
    payload = {
        "posts": [{
            ...
            "status": "published",
            "tags": [{"name": "GTA 6"}, {"name": "News"}], "feature_image": "https://picsum.photos/1600/900"
        }]
    }
